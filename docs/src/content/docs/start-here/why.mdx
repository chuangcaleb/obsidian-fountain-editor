...
<Aside title="tl;dr">
	⚡ Supercharge Fountain with Obsidian, and its design philosophy. Oh, and also
	💸 100% free.
</Aside>

A few years ago, I was on the hunt for an apps for writing screenplays. The industry standard ones were very expensive. I did find [a few great options](/resources/related-projects) too, that I've used for a great many ten thousands of words! I would still vouch for them, so you may want to consider them.

I also came to learn about [Fountain](https://fountain.io), used it, and I never want to write any other way. Its markdown-esque simplicity tickles the software developer inside of me. Its design did lend to some shortcomings, but this project aims to make the most out of Fountain.
...
Fountain is born out of the same dream-waters as Markdown. While there are a few cases of [syntax conflicts](/resources/syntax-conflicts), I've found the syntaxes to be very **💕 complementary**.
...
You actually don't even need this Obsidian plugin. Fountain was designed for apps that don't have a [WYSIWYG editor](https://en.wikipedia.org/wiki/WYSIWYG), in bare unstyled plaintext. You could implement the paradigms without "Live Preview" formatting. But the main purpose of this plugin is to make your Fountain look pretty :)

## Conclusion

And again, these are my personal + advanced + nitpicking reasons for developing this project. If you just want a ☑️ simple, 🌟 excellent & 💸 free app for screenwriting, I hope that you find it here :), if not among [related projects](/resources/related-projects)!
