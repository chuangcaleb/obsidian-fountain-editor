...
You could split them at any level, really. Into 2 Halves. 3 Acts. 4 Quarters. 8 Story Circle Eights. Per scene. Per sequence. Per chapter. Per arbitrary divisions of varying lengths, with particular thematic thrusts.
...
These three aforementioned enhancements are more like _design principles_ rather than _technical features_. They could be implemented in other markdown editors besides Obsidian (and feel free to!).
...
And again, these are my personal + advanced + nitpicking reasons for developing this project. If you just want a ☑️ simple, 🌟 excellent & 💸 free app for screenwriting, you can also find it here :), if not among [related projects](/docs/src/content/docs/resources/related-projects.mdx)!
